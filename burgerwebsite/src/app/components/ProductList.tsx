        ...
        >
          ...
          <div className="relative pt-10 px-10 flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <Image
              ...
              alt={product.title}
              width={192} // Example width for the image
              height={192} // Example height for the image
            />
          </div>
          ...
          <div className="relative text-white px-6 pb-6 mt-6">
            ...
            <div className="flex flex-col justify-between">
              ...
              <span className=" bg-white rounded-full text-orange-500 text-xs font-bold px-3 py-2 leading-none items-center">
                RS {product.price}
              </span>
            </div>
          </div>
